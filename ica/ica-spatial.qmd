...
Keep zooming -- what level of detail can you get into? You can currently zoom in to a point where paths and roads are able to be seen.
How does that detail depend upon where you try to zoom in (thus what are the limitations of this tool)? This tool is limited by the information it is provided, if there are locations with less location data available, they will appear in comparatively less detail.
